...
⚠️ This package is **abandoned** and no longer maintained. The author suggests using the **[rinvex/laravel-contacts](https://github.com/rinvex/laravel-contacts)** package instead. ⚠️
